...
function Home() {
  ...
  const otherSkills = [
    ...
    { icon: FaRobot, name: "AI/ML", color: "text-purple-400", level: 70 },
    { icon: SiOpenai, name: "OpenAI", color: "text-green-400", level: 75 },
    { icon: SiLangchain, name: "LangChain", color: "text-orange-400", level: 68 },
    { icon: FaN8n, name: "n8n", color: "text-red-400", level: 72 },
  ...
  return (
    <div name="Home" className="relative w-full min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-32">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 sm:gap-12 lg:gap-20">
          ...
          >
            ...
            >
              ...
              Specialized in <span className="text-blue-400">MERN stack</span>, <span className="text-purple-400">Next.js</span>, <span className="text-green-400">WordPress</span>, and 
              <span className="text-orange-400"> AI/ML</span> solutions. Expert in <span className="text-pink-400">Generative AI</span>, 
              <span className="text-red-400"> n8n automation</span>, and <span className="text-yellow-400">LangChain</span> for building intelligent, automated systems.
            </motion.p>
            ...
            >
              ...
              <ScrollLink to="Contact" smooth={true} duration={500} offset={-70} className="cursor-pointer flex-1 sm:flex-none">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* Floating Tech Icons - Updated with AI & n8n */}
                <motion.div
                ...
                >
                  <SiOpenai className="text-white text-lg sm:text-2xl" />
                </motion.div>
                ...
                >
                  <FaN8n className="text-white text-lg sm:text-2xl" />
                </motion.div>
                ...
                >
                  <SiLangchain className="text-white text-lg sm:text-2xl" />
                </motion.div>

                <motion.div
                  animate={{ y: [0, -10, 0], rotate: [0, 8, 0] }}
                  transition={{ duration: 4.2, repeat: Infinity, delay: 1.2 }}
                  className="absolute top-2/3 -right-3 sm:-right-6 p-2 sm:p-3 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-500 shadow-lg"
                >
                  <FaBrain className="text-white text-lg sm:text-2xl" />
                </motion.div>
              </motion.div>
            </div>
          </motion.div>
        ...
        {/* Skills Section - Updated with AI & n8n */}
        <motion.div 
        ...
        >
          ...
          {/* AI & Automation Skills - New Section */}
          <div className="mb-8 sm:mb-12">
            <h3 className="text-base sm:text-xl font-semibold text-pink-400 mb-4 sm:mb-6 text-center flex items-center justify-center gap-2">
              <span className="w-8 sm:w-12 h-px bg-pink-400"></span>
              AI & Automation
              <span className="w-8 sm:w-12 h-px bg-pink-400"></span>
            </h3>
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
              {[
                ...
                { icon: FaN8n, name: "n8n", color: "text-red-400", level: 72 },
                { icon: SiLangchain, name: "LangChain", color: "text-orange-400", level: 68 },
                { icon: FaBrain, name: "Generative AI", color: "text-purple-400", level: 70 },
                { icon: FaRobot, name: "AI/ML", color: "text-pink-400", level: 65 },
                { icon: FaPython, name: "Python AI", color: "text-yellow-400", level: 75 },
              ].map((skill, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, scale: 0 }}
                  ...
                  className="group relative"
                >
                  <div className="p-2.5 sm:p-4 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/10 hover:border-pink-500/50 transition-all duration-300">
                    <skill.icon className={`text-2xl sm:text-4xl md:text-5xl ${skill.color} group-hover:scale-110 transition-transform duration-300`} />
                    <div className="absolute -bottom-6 sm:-bottom-8 left-1/2 transform -translate-x-1/2 text-[8px] sm:text-xs text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap bg-gray-900 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">
                      {skill.name} • {skill.level}%
                    </div>
