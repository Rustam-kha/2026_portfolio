...
function Contact() {
  ...
  const aiServices = [
    { icon: SiOpenai, label: "OpenAI Integration", color: "from-green-500 to-emerald-500" },
    { icon: FaN8n, label: "n8n Automation", color: "from-red-500 to-orange-500" },
    { icon: SiLangchain, label: "LangChain Solutions", color: "from-orange-500 to-yellow-500" },
    { icon: FaBrain, label: "Generative AI", color: "from-purple-500 to-pink-500" },
  ];
                ...
                <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      name="message"
                      rows="5"
                      placeholder="Tell me about your project or AI automation needs..."
            ...
            <div className="relative group h-full">
              ...
              <div className="relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl border border-white/10 p-8 h-full">
                ...
                <div className="mt-8 pt-6 border-t border-white/10">
                  <h3 className="text-sm font-medium text-gray-400 mb-3">AI & Automation Services</h3>
                  <div className="grid grid-cols-2 gap-2">
                    {aiServices.map((service, idx) => (
                      <motion.div
                        key={idx}
                        whileHover={{ scale: 1.05 }}
                        className={`p-2 rounded-lg bg-gradient-to-r ${service.color} bg-opacity-10 border border-white/10 flex items-center gap-2`}
                      >
